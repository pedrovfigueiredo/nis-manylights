...
enum class LightType { VPL, DeltaPosition, DeltaDirection, Area, Infinite };

class VirtualPointLight;
class PointLight;
class DistantLight;
...
class Light : public TaggedPointer<  // Light Source Types
                  VirtualPointLight, PointLight, DistantLight, ProjectionLight, GoniometricLight, SpotLight,
