...
extern "C" __global__ void __raygen__shadow() {
    ...
    RecordShadowRayResult(sr, &params.pixelSampleState, &params.lightSamplerOptStateBuffer, params.lightSampler, !missed);
}
...
extern "C" __global__ void __raygen__shadow_Tr() {
    ...
    TraceTransmittance(sr, &params.pixelSampleState, &params.lightSamplerOptStateBuffer, params.lightSampler,
